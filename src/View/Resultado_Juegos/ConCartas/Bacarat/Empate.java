package View.Resultado_Juegos.ConCartas.Bacarat;
...
public class Empate extends JFrame {
    ...
    private void initComponents() {
        ...
        aviso.setText("                           Has empatado\n "+ View_Bacarat.getTranspasojugador()+ " TU\n "+ View_Bacarat.getTranspasocrupier()+ " BANCA");
    ...
    private void boton_reinicioMouseClicked(MouseEvent evt) {
        new View_Bacarat().setVisible(true);
        dispose();
    }
}